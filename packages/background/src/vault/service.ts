...
import { PlainRecord, Vault } from "./types";
...
export class VaultService {
  ...
  protected decryptedCache: Map<string, PlainRecord> = new Map();
  ...
  protected encrypt(sensitive: PlainRecord): Uint8Array {
  ...
  decrypt(sensitive: Uint8Array): PlainRecord {
    this.ensureUnlockAndState();
